...
public class TicketRepository implements DatabaseManipulation<Ticket> {
     ...
     * Because ticketIdentifier is randomly generated and because this must be unique,
     * every time when a ticket is created a unique ticket identifier is generated by checking that a ticket with this
     * ticketIdentifier does not exist in the database.
     *
     * @return boolean
     */
     ...
     * Is used in GUI when an organizer clicks on view sold ticket button.
     *
     ...
     * Is used in GUI when a client clicks on view ticket button.
     *
     * @return list of tickets
     */
    ...
    /**
     * Make a list and return all tickets from the database if necessary.
     *
     * @return List
     */
    @Override
    ...
    /**
     * Return a single ticket from the database when the selector is ticket identifier.
     *
     * @return ticket
     */
    ...
    /**
     * Return a single ticket from the database when the selector is primary key.
     *
     * @return ticket
     */
    @Override
    ...
    /**
     * Main function for inserting a new ticket into the database.
     *
     * @param ticket object which will be inserted into the database
     */
    @Override
    ...
    /**
     * Main function for updating an existing ticket from the database.
     *
    ...
    /**
     * Main function for deleting existing ticket from the database.
     *
     * @param ticket object which will be deleted from the database
     */
    @Override
